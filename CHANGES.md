...
- Fixed bounding spheres of instanced primitives (`EXT_mesh_gpu_instancing`) ignoring instance rotation and scale, which could cull instanced geometry when the canonical mesh is far from its instances.
